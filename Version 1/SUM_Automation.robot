...
Test main
    ...
    \    run keyword if     '${condition5}'=='PASS'    Test End    ${ip_name}
...
Test Inventory 
    wait until page contains    Perform inventory   timeout=8 min
    ...
    wait until page contains    Ready for deployment    timeout=50 min
...
Test Deployment
    ...
    ${selected}=    get text    xpath:/html[1]/body[1]/div[2]/div[4]/div[1]/div[1]/section[1]/form[1]/ol[1]/li[5]/div[1]/ol[1]/li[2]/ol[1]/li[1]/div[1]/ol[1]/div[1]/ol[1]/li[2]/div[1]/div[4]/b[1]/label[1]
...
Test Selection
    [Arguments]     @{words}
    sleep   1 min
    ${total}=      get text     xpath:/html[1]/body[1]/div[2]/div[4]/div[1]/div[1]/section[1]/form[1]/ol[1]/li[5]/div[1]/ol[1]/li[2]/ol[1]/li[1]/div[1]/ol[1]/div[1]/ol[1]/li[2]/div[1]/div[2]/b[1]/label[1]
    ...
    \   click element   xpath:/html[1]/body[1]/div[2]/div[4]/div[1]/div[1]/section[1]/form[1]/ol[1]/li[5]/div[1]/ol[1]/li[2]/ol[1]/li[1]/div[1]/ol[1]/div[1]/ol[1]/li[2]/div[1]/div[5]/div[3]/table[1]/tbody[1]/tr[${inc}]/td[1]
    \   sleep  20
...
Test Log
    ...
    click element   xpath://a[@class='hp-button company-a']
    sleep   2
    click element   xpath://a[@class='hp-button']
    sleep   2
    ...
    \   ${name}     get text    xpath://div[@class='hp-grid-panel hp-grid-span-12 hp-grid-height-5']//div[@class='hp-panel-contents']
    ...
    \   ${entry}     Get value      xpath://textarea[@id='log-details']
    \   create File     ${output}\\${spp_dir_name}\\${day}\\output_logs\\${ip_name}\\${name}.txt
    \   Append to file      ${output}\\${spp_dir_name}\\${day}\\output_logs\\${ip_name}\\result.txt     ${name} : ${result} \n
    \   Append to File     ${output}\\${spp_dir_name}\\${day}\\output_logs\\${ip_name}\\${name}.txt   ${entry}
    \   Append To File     ${output}\\${spp_dir_name}\\${day}\\output_logs\\Details\\dash.txt     ${ip_name} ${name} ${result} \n
    [Return]      ${ip_name}
...
loop
    ...
    \    ${stat2}=   Run Keyword If  '${component}'!='Both'  run keyword and return status  element should contain  xpath://li[@id='hpsum-node-deploy-baselines']//tbody//tr[${inc}]//td[4]  ${component}
    \    run keyword if  '${component}'=='Both'   set test Variable   ${stat2}    True
    \    ${stat1}=    run keyword and return status  element should contain      xpath://li[@id='hpsum-node-deploy-baselines']//tbody//tr[${inc}]//td[2]     ${search_elem}
...
Test Firmware All
    ...
    :For    ${inc}  IN RANGE    1   ${total}+1
    \    ${fw_stat}   run keyword and return status  element should contain  xpath://li[@id='hpsum-node-deploy-baselines']//tbody//tr[${inc}]//td[4]  Firm
    \    ${slno}=     Convert to String  ${inc}     
