...
class new:
    def __init__(self,ip,comp,stat):
        ...
        if self.stat == 'Update returned an error. ':
            self.ip_status = Message(frame,text=self.stat, font=('Helvetica', 14, 'bold'),width=500,bd=1,bg="#fbeec1",fg="red")
        elif self.stat == 'Success,':
            self.stat = 'Success, reboot required to activate new version.'
            self.ip_status = Message(frame,text=self.stat, font=('Helvetica', 14, 'bold'),width=500,bd=1,bg="#fbeec1",fg="green")
        elif self.stat == 'The':
        ...
        self.component_label = Message(frame, text=self.comp, font=('Helvetica', 13,) ,width=1000 ,bd=1,bg="#fbeec1")
        ...
        if self.stat=="Baseline_addition_failed":
            ...
            pass
        elif self.stat=='Update returned an error. ':
            pass
        else:
...
def myfunction(event):
    canvas.configure(scrollregion=canvas.bbox("all"),width=1850,height=870)
