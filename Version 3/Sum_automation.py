    ...
    if len(sys.argv)>1:
        if len(sys.argv)==2 and sys.argv[1]=='--help':
            ...
            if sys.argv[1]=='--prerequisite_only' and sys.argv[2]=='--input':
                ...
                os.system('cmd /c "robot -v pid:"'+str(os.getpid())+'" -v input:no -v input_file:"'+sys.argv[3]+'" -l repo_clear_log.html -r repo_clear_report.html iLO_repo.robot > repo_clear_debug_details"')
                time.sleep(300)
                ...
                os.system('cmd /c "robot -v pid:"'+str(os.getpid())+'" -v input:no -v input_file:"'+sys.argv[3]+'" -l sum_automation_log.html -r sum_automation_report.html SUM_Automation.robot > sum_automation_debug_details"')
            else:
            ...
            if sys.argv[1]=='--input' and sys.argv[2]!="":
                print("SUM Automation in progres...")
                os.system('cmd /c "robot -v pid:"'+str(os.getpid())+'" -v input:no -v input_file:"'+sys.argv[2]+'" -l sum_automation_log.html -r sum_automation_report.html SUM_Automation.robot > sum_automation_debug_details"')
            else:
                print("--help for the help")
        else:
            print("--help for the help")
    else:
        os.system('cmd /c "robot -v pid:"'+str(os.getpid())+'" -v input:yes -l sum_automation_log.html -r sum_automation_report.html SUM_Automation.robot > sum_automation_debug_details"')
except:
