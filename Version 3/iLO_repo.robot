...
#        select frame  id=appFrame
        run keyword and ignore error  click element  xpath:/html[1]/body[1]/div[9]/div[1]/div[3]/button[1]
        close all browsers
    END
...
Test frame new
    ...
    run keyword and ignore error  click element  xpath:/html[1]/body[1]/div[5]/div[2]/div[1]/button[1]
    #/html[1]/body[1]/div[5]/div[1]/div[1]/button[1]/span[2]
...
Test frame old  
    ...
    ${status}  run keyword and ignore error  select frame  id=iframeContent
    wait until page contains  Remove all
    run keyword and ignore error  click button  xpath:/html[1]/body[1]/div[5]/div[1]/div[1]/button[1]
    #/html[1]/body[1]/div[5]/div[1]/div[1]/button[1]/span[2]
...
loop
    ...
    click element  xpath:/html[1]/body[1]/div[4]/div[1]/div[1]/div[1]/div[1]/nav[1]/ul[1]/li[3]/a[1]
